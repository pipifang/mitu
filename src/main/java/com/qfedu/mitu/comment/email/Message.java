...
public class Message {
    ...
    public static boolean sendCode(String tel , String code )throws Exception{
        String code_Str = URLEncoder.encode("#code#="+code, "utf-8");
        System.out.println(code_Str);
        //准备URL对象，将接口包装在此对象中
        URL url = new URL("http://v.juhe.cn/sms/send?mobile="+tel+
                "&tpl_id=模板id&tpl_value="+code_Str+"&key=");
        //打开对象
